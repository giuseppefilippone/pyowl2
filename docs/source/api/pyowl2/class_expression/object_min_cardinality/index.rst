...
.. only:: html
    ...
    .. figure:: /_uml/pyowl2_class_expression_object_min_cardinality_OWLObjectMinCardinality.png
...
.. only:: latex
    ...
    .. figure:: /_uml/pyowl2_class_expression_object_min_cardinality_OWLObjectMinCardinality.pdf
       :alt: UML Class Diagram for OWLObjectMinCardinality
       :align: center
       :width: 100%
       :class: uml-diagram
