...
.. only:: html
    ...
    .. figure:: /_uml/pyowl2_class_expression_object_max_cardinality_OWLObjectMaxCardinality.png
...
.. only:: latex
    ...
    .. figure:: /_uml/pyowl2_class_expression_object_max_cardinality_OWLObjectMaxCardinality.pdf
       :alt: UML Class Diagram for OWLObjectMaxCardinality
       :align: center
       :width: 100%
       :class: uml-diagram
