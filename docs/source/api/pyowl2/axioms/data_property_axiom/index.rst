pyowl2.axioms.data_property_axiom
=================================

.. only:: html

    .. figure:: /_uml/module_pyowl2_axioms_data_property_axiom.png
       :alt: UML Class Diagram for pyowl2.axioms.data_property_axiom
       :align: center
       :width: 100%
       :class: uml-diagram

       UML Class Diagram for **pyowl2.axioms.data_property_axiom**

.. only:: latex

    .. figure:: /_uml/module_pyowl2_axioms_data_property_axiom.pdf
       :alt: UML Class Diagram for pyowl2.axioms.data_property_axiom
       :align: center
       :width: 100%
       :class: uml-diagram
...
.. py:module:: pyowl2.axioms.data_property_axiom
...
.. toctree::
   ...
   /api/pyowl2/axioms/data_property_axiom/data_property_domain/index
   /api/pyowl2/axioms/data_property_axiom/data_property_range/index
   /api/pyowl2/axioms/data_property_axiom/disjoint_data_properties/index
   /api/pyowl2/axioms/data_property_axiom/equivalent_data_properties/index
   /api/pyowl2/axioms/data_property_axiom/functional_data_property/index
   /api/pyowl2/axioms/data_property_axiom/sub_data_property_of/index
